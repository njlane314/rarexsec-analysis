...
private:
    ...
    static const std::vector<std::string>& truthVariables() {
        static const std::vector<std::string> v = {
            ...
            "neutrino_energy", "lepton_energy",
            "count_mu_minus", "count_mu_plus",
            "count_e_minus", "count_e_plus",
            "count_pi_zero", "count_pi_plus", "count_pi_minus",
            "count_proton", "count_neutron",
            "count_kaon_zero", "count_kaon_plus", "count_kaon_minus",
            "count_lambda",
            "count_sigma_zero", "count_sigma_plus", "count_sigma_minus",
