    ...
    void onFinalisation(const RegionAnalysisMap &region_map) override {
        ...
        for (auto const &pc : plots_) {
            ...
            UnstackedHistogramPlot plot(
                "unstack_" + pc.variable + "_" + pc.region, variable_result,
                region_analysis, pc.category_column, pc.output_directory, cuts,
                pc.annotate_numbers, pc.use_log_y, pc.y_axis_label,
                pc.area_normalise);
