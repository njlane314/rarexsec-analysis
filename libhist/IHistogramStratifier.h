...
public:
    ...
    std::unordered_map<StratumKey, ROOT::RDF::RResultPtr<TH1D>> stratifyHist(
...
protected:
    virtual ROOT::RDF::RNode defineFilterColumn(
        ROOT::RDF::RNode dataframe, int key, const std::string& new_column_name) const = 0;
