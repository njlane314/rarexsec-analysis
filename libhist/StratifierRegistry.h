...
public:
    StratifierRegistry() {
        ...
        this->addScheme("inclusive_strange_channels", StratifierType::kScalar, {
            ...
            {11, "numu_cc_ms", R"(#nu_{#mu}CC Ms)", kGreen+2, 1001}, {20, "numu_cc_np0pi", R"(#nu_{#mu}CC Np0#pi)", kRed, 1001},
            {21, "numu_cc_0pnpi", R"(#nu_{#mu}CC 0pN#pi)", kRed-7, 1001}, {22, "numu_cc_npnpi", R"(#nu_{#mu}CC NpN#pi)", kOrange, 1001},
            {23, "numu_cc_other", R"(#nu_{#mu}CC Other)", kViolet, 1001}, {30, "nue_cc", R"(#nu_{e}CC)", kMagenta, 1001},
            {31, "nc", R"(#nu_{x}NC)", kBlue, 1001}, {98, "out_fv", "Out FV", kGray+1, 3004},
            {99, "other", "Other", kCyan, 1001}
        });

        this->addScheme("exclusive_strange_channels", StratifierType::kScalar, {
            {0, "Data", "Data", kBlack, 1001}, {1, "External", "External", kGray, 3004},
            {2, "Dirt", "Dirt", kGray+2, 1001}, {30, "nue_cc", R"(#nu_{e}CC)", kGreen+2, 1001},
            {31, "nc", R"(#nu_{x}NC)", kBlue+1, 1001}, {32, "numu_cc_other", R"(#nu_{#mu}CC Other)", kCyan+2, 1001},
            {50, "numu_cc_kpm", R"(#nu_{#mu}CC K^{#pm})", kYellow+2, 1001}, {51, "numu_cc_k0", R"(#nu_{#mu}CC K^{0})", kOrange-2, 1001},
            {52, "numu_cc_lambda", R"(#nu_{#mu}CC #Lambda^{0})", kOrange+8, 1001}, {53, "numu_cc_sigmapm", R"(#nu_{#mu}CC #Sigma^{#pm})", kRed+2, 1001},
            {54, "numu_cc_lambda_kpm", R"(#nu_{#mu}CC #Lambda^{0} K^{#pm})", kRed+1, 1001}, {55, "numu_cc_sigma_k0", R"(#nu_{#mu}CC #Sigma^{#pm} K^{0})", kRed-7, 1001},
            {56, "numu_cc_sigma_kmp", R"(#nu_{#mu}CC #Sigma^{#pm} K^{#mp})", kPink+8, 1001}, {57, "numu_cc_lambda_k0", R"(#nu_{#mu}CC #Lambda^{0} K^{0})", kPink+2, 1001},
            {58, "numu_cc_kpm_kmp", R"(#nu_{#mu}CC K^{#pm} K^{#mp})", kMagenta+2, 1001}, {59, "numu_cc_sigma0", R"(#nu_{#mu}CC #Sigma^{0})", kMagenta+1, 1001},
            {60, "numu_cc_sigma0_kpm", R"(#nu_{#mu}CC #Sigma^{0} K^{#pm})", kViolet+1, 1001}, {61, "numu_cc_other_strange", R"(#nu_{#mu}CC Other Strange)", kPink-9, 1001},
            {98, "out_fv", "Out FV", kGray+1, 3004}, {99, "other", "Other", kGray+3, 1001}
        });
