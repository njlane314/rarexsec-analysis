...
class StratifierRegistry {
  ...
  public:
    StratifierRegistry() {
        ...
        this->addScheme(
            ...
            [](const ROOT::RVec<int> &pdg_codes, int key) {
                ...
                if (key == -1) {
                    if (pdg_codes.empty())
                        return false;
                    const std::set<int> known_pdgs = {
                        0, 11, 13, 22, 211, 321, 2112, 2212, 3112, 3222};
                ...
                if (key == 3222) {
                    return ROOT::VecOps::Sum(
                               ROOT::VecOps::abs(pdg_codes) == 3222 ||
        ...
        this->addScheme("blip_pdg", StratifierType::kVector,
                        ...
                        [](const ROOT::RVec<int> &pdg_codes, int key) {
                            ...
                            return ROOT::VecOps::Sum(
                                       ROOT::VecOps::abs(pdg_codes) == key) > 0;
                        });
    ...
    const StratumProperties &
    getStratumProperties(const std::string &scheme_name, int key) const {
