    ...
    this->addScheme(
        ...
        {2, "out_fv", "Outside Fiducial Volume",
         ...
         {11, "cc1pipm", R"(CC1#pi^{#pm})",
          static_cast<Color_t>(TColor::GetColor("#56B4E9")), 1001},
         {12, "ccpi0_gg", R"(CC#pi^{0}#rightarrow#gamma#gamma)",
          static_cast<Color_t>(TColor::GetColor("#009E73")), 1001},
         {13, "cc_multi_pi", R"(CC multi-#pi)",
          static_cast<Color_t>(TColor::GetColor("#D55E00")), 1001},
         {14, "nc", "Neutral Current",
          static_cast<Color_t>(TColor::GetColor("#0072B2")), 1001},
         {15, "cc_single_strange", "CC single strange",
          static_cast<Color_t>(TColor::GetColor("#F0E442")), 1001},
         {16, "cc_assoc_strange", "CC associated strange",
          static_cast<Color_t>(TColor::GetColor("#CC79A7")), 1001},
         {17, "nue_cc", R"(#nu_{e}~CC)",
          static_cast<Color_t>(TColor::GetColor("#8A2BE2")), 1001},
         {99, "other", "Other", static_cast<Color_t>(TColor::GetColor("#999999")),
          1001}});
  }
