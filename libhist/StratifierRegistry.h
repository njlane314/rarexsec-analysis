    ...
    this->addScheme(
        ...
        {{0, "data", "Data", kBlack, 1001},
         {1, "cosmic_dirt", "Cosmic or Dirt Background",
          TColor::GetColor("#7f7f7f"), 3345},
         {2, "out_fv", "Outside Fiducial Volume",
          TColor::GetColor("#bdbdbd"), 3354},
         {10, "cc0pi", R"(CC0#pi(#mu+Np))",
          TColor::GetColor("#E69F00"), 1001},
         {11, "cc1pipm", R"(CC1#pi^{#pm})",
          TColor::GetColor("#56B4E9"), 1001},
         {12, "ccpi0_gg", R"(CC#pi^{0}#rightarrow#gamma#gamma)",
          TColor::GetColor("#009E73"), 1001},
         {13, "cc_multi_pi", R"(CC multi-#pi)",
          TColor::GetColor("#D55E00"), 1001},
         {14, "nc", "Neutral Current",
          TColor::GetColor("#0072B2"), 1001},
         {15, "cc_single_strange", "CC single strange",
          TColor::GetColor("#F0E442"), 1001},
         {16, "cc_assoc_strange", "CC associated strange",
          TColor::GetColor("#CC79A7"), 1001},
         {17, "nue_cc", R"(#nu_{e}~CC)",
          TColor::GetColor("#8A2BE2"), 1001},
         {99, "other", "Other", TColor::GetColor("#999999"), 1001}});
  }
